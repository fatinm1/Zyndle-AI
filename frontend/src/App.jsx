    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">
            ...
            {authService.isAuthenticated() ? (
              <>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setShowVideoInput(true)}
                  className="px-10 py-5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl font-bold text-xl text-white hover:from-blue-600 hover:to-purple-600 transition-all duration-300 flex items-center space-x-3 shadow-lg hover:shadow-xl"
                >
                ...
                <motion.button
                  ...
                  className="px-10 py-5 bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-xl font-bold text-xl text-white hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="glass-dark rounded-2xl p-8 text-center hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 border border-white/10 group-hover:border-white/20">
                <div className="w-20 h-20 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <div className="w-24 h-24 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold text-white shadow-2xl shadow-blue-500/25 group-hover:scale-110 transition-all duration-300">
              1
            </div>
            <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-blue-400 transition-colors duration-300">
              Paste YouTube URL
          ...
          <motion.div
            ...
            className="group text-center"
          >
            <div className="w-24 h-24 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold text-white shadow-2xl shadow-purple-500/25 group-hover:scale-110 transition-all duration-300">
              2
            </div>
          ...
          <motion.div
            ...
            className="group text-center"
          >
            <div className="w-24 h-24 bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold text-white shadow-2xl shadow-pink-500/25 group-hover:scale-110 transition-all duration-300">
              3
            </div>
